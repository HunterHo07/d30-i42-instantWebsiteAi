...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    Company: [
      ...
      { name: 'Contact', href: 'mailto:contact@instantwebsite.ai' },
    ],
    Resources: [
      { name: 'GitHub', href: 'https://github.com/HunterHo07' },
      { name: 'Support', href: 'mailto:support@instantwebsite.ai' },
    ],
    Legal: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              From name to website in 30 seconds. AI-powered, human-refined websites for everyone.
